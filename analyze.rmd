...
Calculating Williamson's Vw index, which ought to measure the income disparity of the country

$$
\frac{\sqrt{\sum_{i}(y_i - \bar y)^2 * \frac{f_i}{n}}}{\bar y}\\
\bar y = national\ income\ per\ capita\\
y_i = income\ per\ capita\ of\ the\ ith\ prefecture\\
f_i = population\ of\ the\ ith\ prefecture\\
n = population\ of\ Japan
$$